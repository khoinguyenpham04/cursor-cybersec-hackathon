...
// Props are spread onto the Button inside the CollapsibleTrigger render prop,
// so type them as Button props (state-callback props like style/render differ
// between the two Base UI components).
