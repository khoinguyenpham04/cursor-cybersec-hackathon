...
// Base UI 1.6 moved hover delays from Root to Trigger. Accept the classic
// openDelay/closeDelay props on the root and forward them to the trigger via
// context so Radix-flavored callers (e.g. AI Elements) keep working.
